...
Because of the fact that for subnet Router R22 and client C1 Interfaces we need only two IPs, I chose the minimalistic network which will cover those 2 IPes. And the mask is `255.255.255.252` or just `/30`. This mask gives us two hosts which are:<br>
Host 1:
```
HostMin:        0.0.0.1             |   00000000.00000000.00000000.000000|01
```
